...
Merrick Foster	2306913	System Architecture, Platform Features, Technologies Used 
Person 1 input on the website 
	Backend
	Login system 
	Database
	Flag validation
	Scoring system	merrickafoster@students.utech.edu.jm
